...
import { Button, Input, Radio, Space, Select, Image } from "antd";
...
const Applying = () => {
    ...
    return <div className={`row ${classes.main}`}>
        <div className={`col-lg-4 col-md-6 col-sm-12 col-xs-12 ${classes.leftSide}`}>
            <Image preview={false} fluid={true} rounded={true} className={`${classes.img}`} src={require('../../images/Jobie5.png')} />
        </div>
        <div className={`col-lg-8 col-md-6 col-sm-12 col-xs-12 ${classes.rightSide}`}>
            <form className={classes.form} onSubmit={(e) => { e.preventDefault() }}>
                ...
                <div className={classes.control}>
                    ...
                    <Input type={'text'} placeholder="05xxxxxxxx" name='username' id='username'
                        className={classes.customInput}
                        onChange={(e) => {
                ...
                <div className={classes.control}>
                    <label htmlFor='userName'>Your profession</label>
                    <Input type={'text'} placeholder="serial killer" name='username' id='username'
                        className={classes.customInput}
                        onChange={(e) => {
                ...
                <div className={classes.control}>
                    ...
                    <Input type={'text'} placeholder="Blue city" name='username' id='username'
                        className={classes.customInput}
                        onChange={(e) => {
                ...
                <div className={classes.control}>
                    <label htmlFor='skills'>Country</label>

                    <Select showSearch
                        onChange={(e) => setCountry(e)}
                        className={classes.customInput} placeholder={'White country'}
                        style={{ textAlign: 'center' }}
                        // value={country}
                ...
                <div className={classes.action}>
                    <Button loading={isLoading} type={'button'} className={classes.btn} shape="round" htmlType={'submit'} onClick={onApplyHandler}>
                        Apply
                    </Button>
                    <br />
